...
For generation of images of the state space we used images of numbers from 0 to 9 from the mnist dataset. The image_generator() function takes array of the state as input to generate corresponding combined image of mnist numbers.
...
\begin{figure}
	\centering
	\includegraphics[width=4cm,height=4cm,keepaspectratio]{GoalState.png}
	\caption{Goal State}
	\label{fig:1}
\end{figure}
